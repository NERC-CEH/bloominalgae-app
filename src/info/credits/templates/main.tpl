<ul class="table-view">
  ...
  <li>
    ...
    <p>
      ...
      Scottish Environment Protection Agency,  Public Health England & Health Protection Scotland for their support, advice and guidance during the development of this app
    </p>
  </li>
</ul>
