...
// import dummyResponse from './dummy_user_records.json';
        ...
        must: [
          {
            bool: {
              should: [
                {
                  match: {
                    'metadata.survey.id': surveyConfig.id,
                  },
                },
              ],
            },
...
async function init(
  ...
  async function sync() {
    ...
    console.log(
      `SavedSamples: pulled remote verified surveys and found ${updatedLocalOccurrences.length} local matches`
    );
